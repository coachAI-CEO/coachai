...
export default function DrillGeneratorPage() {
  ...
  async function generate() {
    ...
    try {
      const res = await fetch("/api/ai/drill-drill", {
        ...
        body: JSON.stringify({ model, phase,
          zone,
          age,
  ...
  return (
    <main className="max-w-3xl mx-auto p-6">
      ...
      <GameModelSelect value={model} onChange={setModel} helperText="Links the drill to the selected game model." />
  <button
        onClick={generate}
        disabled={loading}
